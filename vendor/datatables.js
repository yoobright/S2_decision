 ...
 *   https://datatables.net/download/#dt/dt-1.11.4/b-2.2.2/fh-3.2.2/sc-2.0.5/sl-1.3.4
 *
 * Included libraries:
 *   DataTables 1.11.4, Buttons 2.2.2, FixedHeader 3.2.2, Scroller 2.0.5, Select 1.3.4
 */
...
(function( $, window, document, undefined ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"dt/dt-1.11.4/b-2.2.2/fh-3.2.2/sc-2.0.5/sl-1.3.4",
