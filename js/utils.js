...
const s1RefText =  {
  ...
  1: [
    {
      "ref": "NCCN （2022版）",
      "content": "轻度疼痛，可选用非阿片类药物和辅助镇痛药物。"
    },
    {
      "ref": "癌症疼痛诊疗规范（2018年版）",
      "content": "对于轻度疼痛（NRS 1~3分）可选用非甾体类抗炎药物。"
    }
  ],
  // 决策二
  2: [
    {
      "ref": " 癌症疼痛诊疗规范（2018年版）",
      "content": "重度疼痛（ NRS 7~10 分）：首选强阿片类药。"
    },
  ],
  // 决策三
  3: [
    {
      "ref": "癌症疼痛诊疗规范（2018年版）",
      "content": "中度疼痛（ NRS 3~7 分）可使用弱阿片类药物。"
    },
  ],
  // 决策四
  4: [
    {
      "ref": "NCCN （2022版）",
      "content": " 烧灼样痛、刺痛、放电样痛等通常是与神经损伤引起的神经性疼痛有关，建议进行ID Pain筛查与评估。ID Pain 量表评分≥ 2 分，考虑存在神经病理性疼痛，可试用抗抑郁药和/或试用抗惊厥药。"
    },
    {
      "ref": "癌症疼痛诊疗规范（2018年版）",
      "content": "如果患者诊断为神经病理性疼痛，应首选三环类抗抑郁药物或抗惊厥类药物等。"
    }
  ],
  // 决策五
  5: [
    {
      "ref": "癌症疼痛诊疗规范（2018年版）",
      "content": "重度疼痛 （NRS 7~10分） 首选强阿片类药物，并可合用非甾体类抗炎药物及辅助镇痛药物。非甾体类抗炎药物和对乙酰氨基酚是癌痛治疗常用药物，与阿片类药物联合用于缓解中、重度疼痛。"
    }
  ],
  // 决策六
  6: [
    ...
    {
      "ref": "癌症疼痛诊疗规范（2018年版）",
      "content": "重度疼痛 （ NRS 7~10分） 首选强阿片类药，并可合用非甾体类抗炎药物及辅助镇痛药物。"
    },
    {
      "ref": "癌症疼痛诊疗上海专家共识（2017年版）",
      "content": "辅助镇痛药物常用于辅助治疗神经病理性疼痛、骨痛和内脏痛。包括抗惊厥类药物(加巴喷丁、普瑞巴林)、抗抑郁类药物等。"
    }
  ],
  // 决策七
  7: [
    ...
    {
      "ref": "癌症疼痛诊疗规范（2018年版）",
      "content": "中度疼痛（NRS 3 ~7 分）可选用弱阿片类药物或低剂量的强阿片类药物 ，并可联合应用非甾体类抗炎药物以及辅助镇痛药物(镇静剂、抗惊厥类药物和抗抑郁类药物等)。"
    },
    {
      "ref": "癌症疼痛诊疗上海专家共识（2017年版）",
      "content": "辅助镇痛药物常用于辅助治疗神经病理性疼痛、骨痛和内脏痛。包括抗惊厥类药物(加巴喷丁、普瑞巴林)、抗抑郁类药物等。"
